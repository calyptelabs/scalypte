...
public class SetCommandTransactionTest extends TestCase{
	...
	public void test_keyN_value1_not_exist() throws IOException {
		client.testRequest(
				CommandHelper.set_keyN_value1_not_exist
		);
	}

	public void test_key1_valueN_not_exist() throws IOException {
		client.testRequest(
				CommandHelper.set_key1_valueN_not_exist
		);
	}
	
	public void test_key1_value1_not_exist() throws IOException {
		client.testRequest(
				CommandHelper.set_key1_value1_not_exist
		);
	}
	...
	public void test_keyN_valueN_exist() throws IOException {
		client.testRequest(
				...
				CommandHelper.set_keyN_valueN_exist
		);
	}
	...
	public void test_key1_valueN_exist() throws IOException {
		client.testRequest(
				...
				CommandHelper.set_key1_valueN_exist
		);
	}
	...
	public void test_key1_value1_exist() throws IOException {
		client.testRequest(
				...
				CommandHelper.set_key1_value1_exist
		);
	}
