...
public class ReplaceCommandTransactionTest extends TestCase{
	...
	public void test_keyN_value1_not_exist() throws IOException {
		client.testRequest(
				CommandHelper.replace_keyN_value1_not_exist
		);
	}

	public void test_key1_valueN_not_exist() throws IOException {
		client.testRequest(
				CommandHelper.replace_key1_valueN_not_exist
		);
	}
	
	public void test_key1_value1_not_exist() throws IOException {
		client.testRequest(
				CommandHelper.replace_key1_value1_not_exist
		);
	}
	...
	public void test_keyN_valueN_exist() throws IOException {
		client.testRequest(
				...
				CommandHelper.replace_keyN_valueN_exist
		);
	}
	...
	public void test_key1_valueN_exist() throws IOException {
		client.testRequest(
				...
				CommandHelper.replace_key1_valueN_exist
		);
	}
	...
	public void test_key1_value1_exist() throws IOException {
		client.testRequest(
				...
				CommandHelper.replace_key1_value1_exist
		);
	}
