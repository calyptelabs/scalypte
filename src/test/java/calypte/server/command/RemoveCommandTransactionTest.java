...
public class RemoveCommandTransactionTest extends TestCase{
	...
	public void test_keyN_value1_not_exist() throws IOException {
		client.testRequest(
				CommandHelper.remove_keyN_value1_not_exist
		);
	}

	public void test_key1_valueN_not_exist() throws IOException {
		client.testRequest(
				CommandHelper.remove_key1_valueN_not_exist
		);
	}
	
	public void test_key1_value1_not_exist() throws IOException {
		client.testRequest(
				CommandHelper.remove_key1_value1_not_exist
		);
	}
